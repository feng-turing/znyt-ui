  ...
  <div class="app-container">
    <el-dialog :title="title" :visible.sync="open" width="800px" top="5vh" append-to-body>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="handleAddActivityGoods" :disabled="multiple">确 定</el-button>
  ...
  export default {
    ...
    methods: {
      ...
      handleSelectionChange(selection) {
        ...
        this.price = selection.map(item => item.commodityPrice);
      ...
      //弹出层打开
      show(areaName) {
        this.queryParams.searchValue = areaName;
        this.getList();
        this.open = true;
      },
      ...
      handleAddActivityGoods() {
        const data = {
          activityCommodityIds: this.ids,
          activityPrices: this.price,
        }
        this.$emit('ok', data);
        this.open = false;
